...
accident <- read_csv("Motor_Vehicle_Collisions_-_Crashes.csv") %>%
    ...
    select(-c(`VEHICLE TYPE CODE 1`, `VEHICLE TYPE CODE 2`, `VEHICLE TYPE CODE 3`, `VEHICLE TYPE CODE 4`, `VEHICLE TYPE CODE 5`, `CONTRIBUTING FACTOR VEHICLE 1`, `CONTRIBUTING FACTOR VEHICLE 2`, `CONTRIBUTING FACTOR VEHICLE 3`, `CONTRIBUTING FACTOR VEHICLE 4`, `CONTRIBUTING FACTOR VEHICLE 5`)) %>%
    rename(
...
train_df <- train_df %>%
    mutate(
        serious = selector(`LATITUDE`, `LONGITUDE`)
    )
