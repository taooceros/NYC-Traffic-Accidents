...
af <- accidents_full %>%
    select(`NUMBER OF PERSONS INJURED`,Foggy, Smoke, Heavy.Fog, `VEHICLE TYPE CODE 1`, PRCP, SNOW, Ice.Fog, DayLight, `BOROUGH`, `LOCATION_SPLIT`, at_crossing, two_wheel_involved, truck_involved) %>%
    drop_na()
set.seed(123)
