...
af <- accidents_full %>%
    select(Foggy, Smoke, Heavy.Fog, startsWith(`VEHICLE TYPE CODE`), TMAX, TMIN, `CONTRIBUTING FACTOR VEHICLE 1`, PRCP, SNOW, Ice.Fog, DayLight, vehicle, `BOROUGH`, `LOCATION_SPLIT`, `CROSS STREET`, `NUMBER OF PERSONS INJURED`, `LONGITUDE`, `LATITUDE`) %>%
    drop_na()
set.seed(123)
